              ...
              enum i3c_ccc_enthdr_mode_values mode)
{
    ...
    memset(&ccc_payload, 0, sizeof(ccc_payload));
    ccc_payload.ccc.id = I3C_CCC_ENTHDR(mode);
                            ...
                            struct i3c_ccc_setxtime_data *data)
{
    ...
    memset(&ccc_payload, 0, sizeof(ccc_payload));
    ccc_payload.ccc.id = I3C_CCC_SETXTIME(true);
    ...
    /* +1 for defining byte */
    ccc_payload.ccc.data_len = (data->len + 1U);
    ccc_payload.ccc.data = &td[0];
                        ...
                        struct i3c_ccc_setxtime_data *data)
{
    ...
    ccc_tgt_payload.addr = target->dynamic_addr;
    ccc_tgt_payload.rnw = 0;
    ccc_tgt_payload.data = &td[0];
    ccc_tgt_payload.data_len = (data->len + 1U);

    ccc_payload.ccc.id = I3C_CCC_SETXTIME(false);
    ccc_payload.targets.payloads = &ccc_tgt_payload;
    ccc_payload.targets.num_targets = 1;
                        ...
                        uint32_t *data)
{
    ...
    ccc_tgt_payload.rnw = 1;
    ccc_tgt_payload.data = &td[0];
    ccc_tgt_payload.data_len = sizeof(td);

    memset(&ccc_payload, 0, sizeof(ccc_payload));
    ccc_payload.ccc.id = I3C_CCC_GETXTIME;
    ccc_payload.targets.payloads = &ccc_tgt_payload;
    ccc_payload.targets.num_targets = 1;
