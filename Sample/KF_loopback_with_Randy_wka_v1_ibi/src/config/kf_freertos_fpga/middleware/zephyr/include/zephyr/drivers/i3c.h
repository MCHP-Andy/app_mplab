...
#define USE_MCHP_H3_CHANGES

#define CONFIG_I3C_USE_IBI
...
#ifdef USE_MCHP_H3_CHANGES
enum i3c_sec_config_type {
	I3C_SEC_MODE_HOST,
	I3C_SEC_MODE_SECONDARY,
	I3C_SEC_MODE_TARGET,
};
#endif 
...
#ifdef USE_MCHP_H3_CHANGES
static inline int i3c_do_ccc(const struct device *dev,
                    struct i3c_ccc_payload *payload)
#else
 ...
 */
#ifdef USE_MCHP_H3_CHANGES
static inline int i3c_transfer(struct i3c_device_desc *target,
...
static inline int i3c_write(struct i3c_device_desc *target,
                const uint8_t *buf, uint32_t num_bytes, bool pec_en, bool hdr_en)
#else
static inline int i3c_write(struct i3c_device_desc *target,
...
#ifdef USE_MCHP_H3_CHANGES
    if(true == pec_en) {
        msg.flags |= I3C_MSG_PEC;
    }
    if(true == hdr_en) {
        msg.flags |= I3C_MSG_HDR;
    }
#endif
...
static inline int i3c_read(struct i3c_device_desc *target,
               uint8_t *buf, uint32_t num_bytes, bool pec_en, bool hdr_en)
#else
static inline int i3c_read(struct i3c_device_desc *target,
...
static inline int i3c_write_read(struct i3c_device_desc *target,
                 ...
                 void *read_buf, size_t num_read, bool pec_en, bool hdr_en)
#else
static inline int i3c_write_read(struct i3c_device_desc *target,
                 const void *write_buf, size_t num_write,
                    ...
                    uint8_t reg_addr, uint8_t *value)
{
    ...
    return i3c_write_read(target,
                  ...
                  value, sizeof(*value), false, false);
#else
    return i3c_write_read(target,
                  &reg_addr, sizeof(reg_addr),
                  value, sizeof(*value));
...
#ifdef USE_MCHP_H3_CHANGES
    return i3c_write(target, tx_buf, 2, false, false);
#else
